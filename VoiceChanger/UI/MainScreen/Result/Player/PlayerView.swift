...
final class PlayerView: UIView {
    ...
    func setupActivityIndicator() {
        ...
        backgroundColor = #colorLiteral(red: 0.2224900723, green: 0.3040249646, blue: 0.5268210769, alpha: 1)
    ...
    func videoPreviewImage(url: URL) -> UIImage? {
        ...
        guard let cgImage = try? generator.copyCGImage(at: CMTime(seconds: 0.5, preferredTimescale: 60), actualTime: nil) else { return nil }
